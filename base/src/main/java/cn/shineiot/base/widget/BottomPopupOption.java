...
public class BottomPopupOption {
    ...
    private void addView(View v) {
        LinearLayoutCompat lin_layout = (LinearLayoutCompat) v.findViewById(R.id.layout_popup_add);
        //Title
        AppCompatTextView tv_pop_title = v.findViewById(R.id.tv_popup_title);
        //取消按钮
        AppCompatButton btn_cancel = v.findViewById(R.id.btn_cancel);
        ...
        if (options != null && options.length > 0) {
            for (int i = 0; i < options.length; i++) {
                ...
                View itemline = LayoutInflater.from(mContext).inflate(R.layout.basetools_popline, null);
                AppCompatButton btn_txt = item.findViewById(R.id.btn_popup_option);
